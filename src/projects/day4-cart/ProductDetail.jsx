...
const ProductDetail = () => {
  ...
  const {renderStars} = useContext(ProductContext)
  const { id } = useParams()
  ...
  return (
    <div className='bg-gray-200 h-screen flex'>
      ...
      <div className=' flex justify-center flex-col items-cente gap-6 font-semibold text-2xl flex-1 h-full'>
        ...
        }} className='bg-green-800/60 text-white outline-none px-4 rounded-full py-1 w-1/2 cursor-pointer mx-auto'>Buy Now</button>
